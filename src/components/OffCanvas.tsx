...
export default function OffCanvas({ onClose, isOpen, children }: iOffCanvas) {
    return (
        <div className='relative flex items-center justify-end w-screen h-[calc(100vh)]'>
            <div className='absolute top-0 left-0 h-full w-full bg-black opacity-40' onClick={onClose} />
            <div className={`relative w-[60%] md:w-[40%] max-w-[400px] h-full bg-white dark:bg-gray-700  rounded-l-xl z-50 transition-transform duration-500`}
